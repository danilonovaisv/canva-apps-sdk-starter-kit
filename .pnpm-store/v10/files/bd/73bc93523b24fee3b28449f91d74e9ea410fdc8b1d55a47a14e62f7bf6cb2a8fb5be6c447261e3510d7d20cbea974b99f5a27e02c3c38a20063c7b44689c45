 ...
 * @internal
 */
function createFormatMessage(locale, pseudolocalize, 
...
reportError = console.error) {
    ...
    values, opts) {
        ...
        return new intl_messageformat_1.IntlMessageFormat(defaultMessage, locale, undefined, opts).format(values);
    }
